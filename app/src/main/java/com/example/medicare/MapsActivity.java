...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
                ...
                if (!TextUtils.isEmpty(address)) {
                    ...
                    try {
                        ...
                        if (addressList != null) {
                            ...
                            makeText(this, "Loaction not found", LENGTH_SHORT).show();
                        }
                    } catch (IOException e) {
                        e.printStackTrace();
                    }
                    ...
                    makeText(this, "Enter location", LENGTH_SHORT).show();
                }
                break;
            ...
            case R.id.hospitals_nearby:
                ...
                makeText(this, "Displaying", LENGTH_SHORT).show();
    ...
    private String getUrl(double latitude, double longitude, String nearbyPlace) {
        ...
        googleURL.append("&key=" + "AIzaSyAbG4Q9ZBtqh46eHB6e7-cg8ITLeUfYfjA");
    ...
    public void onLocationChanged(Location location) {
        //mMap = new GoogleMap().setLocationSource(location);
